...
pub const SETTING_HELP: &[&str] = &[
    ...
    "This setting sets the terminal width and height from the window. Lines then break at the right edge of the window. If this setting is off, the terminal keeps its width. A horizontal scroll bar then shows the columns that are not in the window.",
