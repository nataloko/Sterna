# Sterna — the build record

The stage-by-stage story of how Sterna was built: moved verbatim out of
`PLAN.md` on 2026-08-15 so that the roadmap stays short enough to read at the
start of every session. Nothing here is live status — `PLAN.md` keeps the
decisions, open items, verification gates and risks; `docs/deviations.md` is
the canonical deviation list; `docs/upstream-bugs.md` is the upstream-defect
ledger. References to `PLAN.md` in the text below, and elsewhere in the tree
where they name a stage, a spike result or a measurement, resolve here: they
mean the roadmap as it stood while the work was happening.
...
## Deliberate deviations — the first write-ups
...
**Counters landed 2026-08-16** as deviation 21 — a field in each terminal's
