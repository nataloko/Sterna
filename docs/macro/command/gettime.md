...
Returns the current time in the string variable &lt;strvar&gt;, with the default format "HH:MM:SS". The user can specify the format same as [strftime](https://learn.microsoft.com/en-us/cpp/c-runtime-library/reference/strftime-wcsftime-strftime-l-wcsftime-l). And also, the default format equals "%H:%M:%S" at the &lt;format&gt; argument.
