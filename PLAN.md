...
**Last updated:** 2026-09-08 · **Stage:** 4 complete, deliberate deviations
landing (`docs/deviations.md`) · **Commits:** 959
...
- **Serial auto-reconnect watches for the node rather than being told about
  it** — the five keys run (deviation 23, `docs/serial-reopen.md`), but the
